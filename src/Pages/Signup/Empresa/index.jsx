...
export default function Empresa({ information, verification, isLoading }) {
    return (
        <div className='signup_particular-container'>
            <form className='signup_particular-form'>
                ...
                <div className='signup_particular-wrapper'>
                    <input onChange={(e) => information.setCnpj(e.target.value)} type="text" placeholder='CNPJ' className='signup_input'/>
                    <input onChange={(e) => information.setIe(e.target.value)} type="text" placeholder='IE' className='signup_input'/>
                </div>
                <div className='signup_particular-wrapper'>
                    <input onChange={(e) => information.setNomeEmpresa(e.target.value)} type="text" placeholder='NOME DA EMPRESA' className='signup_input'/>
                </div>
                <div className='signup_particular-wrapper'>
                ...
                <div className='signup_particular-wrapper'>
                    <input onChange={(e) => information.setCpf(e.target.value)} required type="text" placeholder='CPF' className='signup_input'/>
                </div>
                <div className='signup_particular-wrapper'>
                ...
                <button className='signup-button' disabled={isLoading} onClick={verification}>CRIAR CONTA</button>
            </form>
        </div>
    )
}